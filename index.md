...
At an enterprise-wide scale, the core building blocks of an architecture can also be depicted by using the OMESA notation, making it easier to convey a comprehensive high level view supported by a combination of capabilities and their related design patterns.
